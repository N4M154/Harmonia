                ...
                <div className="mt-3">
                  <ul className="flex flex-wrap gap-2">
                    {tags.map((tag, index) => (
                      <li
                        key={index}
                        className="px-3 py-1 rounded-full text-sm bg-violet-500/20 dark:bg-violet-500/30 text-violet-700 dark:text-violet-200 border border-violet-300 dark:border-violet-600/50"
                      >
                        {tag}
                      </li>
                    ))}
